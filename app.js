...
const dbURI = "mongodb+srv://khushigarg:khushigarg@cluster0.ylhqlvx.mongodb.net/?retryWrites=true&w=majority";

mongoose.connect(dbURI, { useNewUrlParser: true, useUnifiedTopology: true , family:4}) //this return promise
